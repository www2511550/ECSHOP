...
URL = 'http://localhost/ecshop/index.php/Index/Member/message';
...
ACTION = 'http://localhost/ecshop/index.php/Index/Member/message';
		...
		<table width="100%">
			<thead style="background:#D6D6D6;">
				<tr>
					...
					&nbsp;&nbsp;个人资料
					<a href="javascript:;" style='float:right;margin-right:30px;color:#0077D2' onclick="editMsg()">编辑</a></th>
				</tr>
			</thead>
		</table>
		<div class="order">
			<div class="o_detail">
				<table width="100%" class="show_tb">
					...
					<tr style="line-height:55px">
						<td style="text-align:right;width:350px;">用户名：</td>
						<td><input type="text" value="<?php echo $user['username'];?>" style="height:25px;" disabled="" name="username" onblur="testUname(this)">&nbsp;&nbsp;<span style='color:#C5282A'></span></td>
					</tr>
					<tr style="line-height:35px">
						<td style="text-align:right">密码：</td>
						<td><input type="password" value="<?php echo $user['password'];?>" disabled="" style="height:25px;" name="password"></td>
					</tr>
				</table>
				<input type="button" value="提交" style="float:right;margin-right:25px;cursor:pointer;width:60px;height:28px;background:#CA3939;color:#fff;font-weight:700;display:none" name="button" onclick="saveMsg()">
			</div>
		</div>
