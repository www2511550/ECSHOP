...
URL = 'http://localhost/ecshop/index.php/Index/Member/address';
...
ACTION = 'http://localhost/ecshop/index.php/Index/Member/address';
...
HISTORY = 'http://localhost/ecshop/index.php/Index/Member/shengyu';
</script>
	...
	<div class="yuyue">
		...
		<table width="100%">
			<thead style="background:#D6D6D6;">
				<tr>
					<th style="color:#111;font-weight:700;text-align:left;font-size:14px">
					&nbsp;&nbsp;已设为默认地址
					<a href="javascript:;" style='float:right;margin-right:30px;color:#0077D2' onclick="editAddress()">编辑</a></th>
				</tr>
			</thead>
		</table>
		<div class="order">
			<div class="o_detail">
				<table width="100%" class="show_tb">
					<tr style="line-height:35px">
						<td style="text-align:right">收货人：</td>
						<td><?php echo $address['address_order'];?></td>
					</tr>
					<tr style="line-height:35px">
					...
					<tr style="line-height:35px">
						...
						<td><?php echo $address['address_tel'];?></td>
					</tr>
				</table>
		<form method="post" id="address">
				<input type="hidden" name="address_id" value="<?php echo $address['address_id'];?>">
				<table width="100%"  style="display:none;" class="hide_tb">
					<tr style="line-height:35px">
						<td style="text-align:right">收货人：</td>
						<td><input type="text" value="<?php echo $address['address_order'];?>" name="address_order" style="line-height:25px"></td>
					</tr>
					<tr style="line-height:35px">
						<td style="text-align:right">收货地址：</td>
						<td><input type="text" value="<?php echo $address['address'];?>" name="address" style="line-height:25px;width:150px"></td>
					</tr>
					<tr style="line-height:35px">
						<td style="text-align:right">联系号码：</td>
						<td><input type="text" value="<?php echo $address['address_tel'];?>" name="address_tel" style="line-height:25px"></td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="submit" value="确定" style="width:80px;height:30px;cursor:pointer;background:#BD0808;color:#fff;float:right">
						</td>
					</tr>
				</table>
		</form>
