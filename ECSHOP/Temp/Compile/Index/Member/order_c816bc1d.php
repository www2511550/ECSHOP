...
URL = 'http://localhost/ecshop/index.php/Index/Member/order';
...
ACTION = 'http://localhost/ecshop/index.php/Index/Member/order';
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
		...
		<div class="order">
			...
			&nbsp;&nbsp;<input type="checkbox">&nbsp;&nbsp;<span style='color:#333'>订单编号： </span>
				<a href="javacript:;"><?php echo $d['order_sn'];?></a>
			...
			<div class="o_detail">
				<ul>
					<li class="li1">
						<a href="<?php echo U('Index/detail',array('goods_id'=>$d['goods_gid']));?>" style="float:left;" target="_blank"><img src="http://localhost/ecshop/<?php echo $d['goods_img'];?>"></a>
						<a href="<?php echo U('Index/detail',array('goods_id'=>$d['goods_gid']));?>" class="gname"  target="_blank"><?php echo $d['goods_name'];?></a>
				...
				<?php if($d['order_goods_status']==0){?>
					<li class="last">
						<a href="<?php echo U('Order/oneOrder',array('id'=>$d['order_goods_id']));?>" class="a1">去付款</a>
						<a href="javascript:;" class="cancel_order" onclick="cancelOrder(<?php echo $d['order_goods_id'];?>)">取消订单</a>
					</li>
				<?php }?>
				<?php if($d['order_goods_status']==1){?>
					<li><span style='color:#0077d2;'>已付款</span></li>
				<?php }?>
				<?php if($d['order_goods_status']==2){?>
					<li><span>已取消</span></li>
				<?php }?>
