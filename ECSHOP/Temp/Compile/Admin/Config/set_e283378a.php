...
URL = 'http://localhost/ecshop/index.php/Admin/Config/set';
...
CONTROLLER = 'http://localhost/ecshop/index.php/Admin/Config';
ACTION = 'http://localhost/ecshop/index.php/Admin/Config/set';
...
CONTROLLERVIEW = 'http://localhost/ecshop/ECSHOP/Admin/View/Config';
...
if($_index_c>=$_total_c):$hd["list"]["c"]["last"]=true;endif;?>
			...
			<tr style="text-align:left">
				<td class="w150"><?php echo $c['title'];?></td>
...
<script type="text/javascript" src="http://localhost/ecshop/ECSHOP/Admin/View/Config/Js/js.js"></script>
</div>	
</body>
</html>