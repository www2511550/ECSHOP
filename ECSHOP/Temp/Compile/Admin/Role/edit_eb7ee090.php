...
URL = 'http://localhost/ecshop/index.php/Admin/Role/edit/rid/1';
...
ACTION = 'http://localhost/ecshop/index.php/Admin/Role/edit';
...
<body>
<div class="wrap">
	<div class="title-header">编辑角色</div>
<form method="post">
	<input type="hidden" name='rid' value="<?php echo $role['rid'];?>">
	<table class="table2 hd-form">
		<tr>
			<th>角色名称</th>
			<td><input type="text" name='rname' value="<?php echo $role['rname'];?>"></td>
		</tr>
		<tr>
