...
URL = 'http://localhost/ecshop/index.php/Admin/Goods/recover';
...
ACTION = 'http://localhost/ecshop/index.php/Admin/Goods/recover';
...
HISTORY = 'http://localhost/ecshop/index.php/Admin/Goods/index/page/6';
</script>
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
			...
			<tr>
				...
				<td>
					<a href="javascript:;" onclick="recover(this,<?php echo $d['goods_id'];?>,0)">还原商品</a> |
