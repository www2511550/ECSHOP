...
URL = 'http://localhost/ecshop/index.php/Admin/Category/add';
...
ACTION = 'http://localhost/ecshop/index.php/Admin/Category/add';
...
echo "";
			...
			<tr>
				<th class="w100">单位</th>
				<td><input type="text" name="measure_unit" value="件"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="cat_key"></td>
			</tr>
			<tr>
				<th class="w100">描述</th>
				<td><textarea name="cat_desc" class="w200 h80"></textarea></td>
			</tr>
		</table>
